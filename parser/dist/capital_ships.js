...
export default {
    Transport: {
        ...
        BuildCost: [250, 1000, 5000, 100000, 200000, 800000, 2000000],
        DesignUpgradeCost: [0, 2000, 60000, 300000, 1000000, 7000000, 31500000],
        DesignUpgradeTime: [0, 120, 86400, 259200, 604800, 864000, 864000],
        RequiredPlanetLevel: 1,
        HP: 1,
        JobCapacity: [1, 2, 3, 4, 6, 18, 60],
        Speed_YS: 600,
        Speed_RS: 240,
        Speed_BLS: 192,
        Speed_WS: 124,
    ...
    Miner: {
        ...
        BuildCost: [400, 800, 8000, 100000, 200000, 800000, 2000000],
        DesignUpgradeCost: [0, 2000, 50000, 250000, 800000, 6000000, 24000000],
        DesignUpgradeTime: [0, 60, 86400, 259200, 604800, 864000, 864000],
        RequiredPlanetLevel: 2,
        HP: 1,
        NumSectorsToMine: [1, 2, 3, 4, 5, 6, 7],
        HydrogenCapacity: [20, 200, 400, 800, 1200, 1600, 2000],
        MiningPeriod: [800, 400, 250, 125, 50, 37, 32],
        MiningPeriod_WS: [30, 25, 20, 15, 12, 11, 10],
        MiningPeriod_RS: [1000, 800, 500, 250, 100, 75, 65],
        Speed_YS: 1200,
        Speed_RS: 240,
        Speed_BLS: 192,
        Speed_WS: 124,
    ...
    Battleship: {
        ...
        HP: [4200, 5000, 6000, 7000, 8000, 9000, 10000],
        HealRate: [350, 417, 500, 583, 667, 750, 833],
        HydrogenCapacity: 0,
        Speed_YS: 660,
        Speed_RS: 250,
        Speed_BLS: 200,
    ...
    CerberusPhoenix: {
        ...
        modules: [
            ...
            },
            {
                ...
                ShieldStrengthPVE: 20000,
                ShieldStrengthPvP: 20000,
                IsAreaShield: 1,
        ...
        modules: [
            {
                ...
                projectile: {
                    ...
                    HP_PvP: 900,
                    DamagePvE: 2000,
                    DamageWhenNeutralizedPvE: 500,
                    DamagePvP: 2000,
                    DamageWhenNeutralizedPvP: 500,
                    DamageRange: 1200,
    ...
    RelicDrone: {
        ...
        RelicLoadTicks: [750, 700, 650, 610, 580, 550, 520, 490, 460, 430, 400, 360, 320, 280, 360],
    },
    FlagshipDartBarrage: {
        ...
        modules: [
            {
                ...
                projectile: {
                    ...
                    HP_PvP: 1000,
                    DamagePvE: 3200,
                    DamageWhenNeutralizedPvE: 1000,
                    DamagePvP: 4000,
                    DamageWhenNeutralizedPvP: 1250,
                    DamageRange: 1200,
                    DamageRangeWhenNeutralized: 600,
                    AdditionalWaypoint: 0,
                    Model: "projectiles/BomberRocket_DrkNeb",
    ...
    DarkPhoenix: {
        ...
        modules: [
            ...
            },
            {
                ...
                EffectRadius: 1400,
                EffectDurationx10: 18000,
                ShieldStrengthPVE: 25000,
                ShieldStrengthPvP: 25000,
                IsAreaShield: 1,
                ActivationDelayWS: 180000,
                EffectDurationx10WS: 10800000,
            },
    ...
    RepairDrone: {
        ...
        OnDeathHealAmount_Combat_PvE: [
            1800, 2000, 2200, 2400, 2600, 2800, 3000, 3200, 3600, 4000, 4500, 5000, 5500, 6200, 7000,
        ],
        OnDeathHealAmount_PvP: [450, 500, 550, 600, 650, 700, 750, 800, 900, 1000, 1125, 1250, 1375, 1550, 1750],
        OnDeathHealAmount_Combat_PvP: [
            1800, 2000, 2200, 2400, 2600, 2800, 3000, 3200, 3600, 4000, 4500, 5000, 5500, 6200, 7000,
        ],
