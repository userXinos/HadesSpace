...
export default {
    ...
    AsteroidBeltAxis1Size: [0, 1500, 1200, 1300, 1300, 1300, 1300, 1300, 1300, 1300, 1300, 1200, 1300, 1300, 1300, 1300, 1300, 1300, 1300, 1300, 1300, 1800, 1300, 1300, 1300, 1300, 1300, 1300, 1300, 1300, 1300, 2000, 1500, 1400, 1400, 1400, 1750, 1000, 1000, 1000, 1000, 1400, 1400, 1500, 1700, 1400, 1400, 1500, 1700],
    AsteroidBeltAxis2Size: [0, 1200, 1500, 1500, 1500, 1500, 1500, 1500, 1500, 1500, 1500, 1400, 1500, 1500, 1500, 1500, 1500, 1500, 1500, 1500, 1500, 1300, 1500, 1500, 1500, 1500, 1500, 1500, 1500, 1500, 1500, 2000, 1300, 1400, 1600, 1600, 1750, 1750, 1750, 1750, 1750, 1800, 1550, 1300, 1200, 1800, 1550, 1300, 1200],
    CerbGroup: [
        null,
        null,
        null,
        ...
        { Name: "RSP6", NumSentinels: [3, 4], NumGuardians: [3, 4], NumColossus: 2 },
        { Name: "RSP7", NumSentinels: [4, 5], NumGuardians: 3, NumColossus: 2 },
        { Name: "RSP8", NumSentinels: [3, 5], NumGuardians: [2, 3], NumColossus: 2, NumPhoenix: 1 },
        { Name: "RSP9", NumSentinels: [4, 5], NumGuardians: [4, 5], NumColossus: 2, NumPhoenix: 1, NumStorm: 1 },
        { Name: "RSP10", NumSentinels: [3, 4], NumGuardians: [4, 5], NumColossus: 2, NumPhoenix: 2, NumStorm: 2 },
        { Name: "RSP11", NumSentinels: [4, 5], NumGuardians: [4, 5], NumColossus: 2, NumPhoenix: 2, NumStorm: 2, NumHydra: 1 },
        null,
        ...
        { Name: "RSP12", NumColossus: 2, NumPhoenix: 2, NumStorm: 2, NumHydra: 1, NumCarrier: 1 },
        null,
