...
export default {
    ...
    ShipmentRelay: {
        ...
        UISortOrder: 55,
        Cost: [
            1500, 5000, 10000, 20000, 30000, 40000, 50000, 60000, 70000, 80000, 100000, 200000, 300000, 400000, 500000,
        ],
        MaxOnOwnSolarSystem: 1,
        MaxPerSector: 1,
        RelayBonusPct: [0, 10, 33, 80, 120, 140, 160, 200, 250, 330, 400, 500, 600, 800, 1100],
        HydroCostPerShipment: [10, 15, 30, 55, 80, 100, 120, 130, 140, 150, 160, 170, 180, 190, 200],
        BuildNotifMode: [0, 1],
        ShowInStarLinks: 1,
        RSLevelReq: [3, 4, 5, 6, 6, 7, 8, 9, 10, 10, 10, 10, 10, 10],
        ConstructionTime: [
            3, 28800, 57600, 86400, 172800, 259200, 345600, 432000, 518400, 604800, 604800, 604800, 604800, 604800,
            604800,
        ],
    },
    QuantumStarGate: {
    ...
    StarHarvester: {
        ...
        RequiredPlanetLevel: 10,
        UISortOrder: 95,
        Cost: [70000, 90000, 140000, 190000, 550000, 1500000, 2100000, 4000000, 8000000, 16000000],
        RequiresStarSector: 1,
        MaxOnOwnSolarSystem: 1,
        MaxPerSector: 1,
        BuildNotifMode: 1,
        ShowInStarLinks: 1,
        SHHydroPerDay: [1000, 1500, 2500, 5000, 6000, 8000, 10000, 12000, 14000, 15000],
        ConstructionTime: 86400,
    },
};
