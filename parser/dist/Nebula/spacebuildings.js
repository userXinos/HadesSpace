...
export default {
    ...
    RedStarScanner: {
        ...
        UISortOrder: 40,
        Cost: [1000, 5000, 20000, 60000, 120000, 250000, 1000000, 2000000, 4000000, 8000000, 16000000, 32000000],
        RequiresEmptySector: 0,
        MaxOnOwnSolarSystem: 1,
        MaxPerSector: 1,
        StarScannerType: 0,
        ...
        BuildNotifMode: 1,
        ShowInStarLinks: 1,
        ConstructionTime: [3, 60, 0, 14400, 86400, 172800, 259200, 345600, 432000, 518400, 604800, 864000, 864000],
    },
    ResearchStation: {
    ...
    StarHarvester: {
        ...
        RequiredPlanetLevel: 10,
        UISortOrder: 95,
        Cost: [140000, 200000, 280000, 550000, 1100000, 2200000],
        RequiresStarSector: 1,
        MaxOnOwnSolarSystem: 1,
        MaxPerSector: 1,
        BuildNotifMode: 1,
        ShowInStarLinks: 1,
        SHHydroPerDay: [1000, 1500, 2000, 4000, 6000, 12000],
        ConstructionTime: [86400, 172800, 259200, 259200, 432000, 432000],
    },
};
