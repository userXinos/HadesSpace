...
export default {
    ...
    TID_BUILDING_TRADINGSTATION_DESCR: "Trade Stations create and accept high value Shipments to and from your planets. They must be placed in an empty sector, not adjacent to other sectors that contain other Trade Stations.",
    ...
    TID_BLD_STAR_HARVESTER_DESCR: "Collects energy from the Yellow Star to generate additional temporary Hydrogen Asteroid Fields near the system's fully used Short Range scanners. Upgrade to increase the amount of Hydrogen detected per day.",
    ...
    TID_BLD_RELAY_DESCR: "Allows you to partially or fully automate Shipment delivery, using Fragments retrieved in Blue Stars. Shipments delivered via the Relay pay a small additional bonus.",
    ...
    TID_MODULE_LOCKDOWN: "LOCKDOWN",
    TID_MODULE_LOCKDOWN_DESCR: "The Miner ship starts consuming on board Hydrogen to activate an impenetrable hull that neutralizes any kind of incoming damage. Enemy ships still target the Miner using regular targeting rules. The effect lasts while there's still Hydrogen on board, or until the Activation timer runs out.",
    ...
    TID_MODULE_CRUNCH_DESCR: "Instantly collects Hydrogen from all asteroid fields in the current sector (limited by the Max Amount and the Miner ship's total capacity). The Hydrogen is collected from the highest capacity Asteroids first. Any Scanned Asteroid fields will be considered last.",
    ...
    TID_DIPLOMACY_OPEN_SYSTEM_DESCR: "Setting your Yellow Star to Open allows potentially any player to visit, via one of your diplomacy partners' gates.",
    ...
    TID_RELAY_CONFIRM_SPEND: "Activate the Shipment Relay on this Sector? The total Hydrogen cost depends on the maximum shipments generated in the sector, and your total Hydrogen storage capacity.",
    ...
    TID_INFLUENCE_DECAY_LABEL: "INFLUENCE DECAY ACTIVE",
    ...
    TID_OBJ_BUILD_TIME_MODULATOR_HINT: "Select a planet level 6 or higher. Press the PRODUCTION button at the bottom of the screen. Scroll down the construction list and select STAR.",
    ...
    TID_TIME_MODULATOR_DELETED: "Your Time Modulator has been deleted as part of the DARK NEBULA update. Instead of a Time Modulator, you can now construct a Star Harvester to help boost your daily Hydrogen income.\\n\\nPress ACCEPT to reclaim <sprite name=''cr''> <c1>{0}</color> used to construct your deleted Time Modulator.",
    TID_TRADE_STATION_REMOVED: "One or more of your Trade Stations have been removed, as they were violating new placement rules. Use the Build menu to place your Stations again for free. After placement, the Stations will immediately restore to their previous upgrade level.",
    TID_HYDRO_CAP_CHANGED: "Your Hydrogen capacity has been changed. Hydrogen capacity now roughly represents the amount of Hydrogen your Empire is expected to produce and consume during a day.\\n\\nFor more information on the DARK NEBULA update, see blog.hadesstar.com",
};
