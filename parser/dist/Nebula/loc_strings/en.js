...
export default {
    ...
    TID_MODULE_LEAP_DESCR_BLS: "Initiates Teleportation to the move target that is closest to the nearest allied Battleship or Drone engaged in combat, anywhere in the Star System. Engaged in combat means the allied Battleship or Drone is actively firing on an enemy target, or is fired on by an enemy target. If there is no ally ship engaged in combat, or no valid move target, Leap cannot be activated.\\n\\nLeap activation is cancelled if the target ally ship is destroyed before the jump.\\n\\nIf the jump completes, Area Damage is applied around the owner ship.\\n\\nCannot be used in Yellow or Red Stars.",
    TID_MODULE_LEAP_DESCR_WS: "Initiates Teleportation to the move target that is closest to the nearest allied Battleship or Drone engaged in combat, anywhere in the Star System. Engaged in combat means the allied Battleship or Drone is actively firing on an enemy player target, or is fired on by an enemy player target. Combat with Cerberus ships does not apply.\\n\\nIf there is no ally ship engaged in combat, or no valid move target, Leap cannot be activated.\\n\\nLeap activation is cancelled if either the target ally ship or teleport destination is destroyed before the jump.\\n\\nIf the jump completes, Area Damage is applied around the owner ship.\\n\\nCannot be used in Yellow or Red Stars.",
    ...
    TID_MODULE_BLAST_SHIELD_DESCR: "When an enemy object within the Blast Shield's range applies Area Damage, the Area Damage amount is reduced by the Blast Shield's remaining Shield Strength. After the reduction, if there is any Area Damage amount remaining, it will be applied to all objects in range as usual.\\n\\nIf there are multiple Blast Shields covering the Area Damage object, they will apply in turn, starting with the Blast Shield that has the least remaining Shield Strength.\\n\\nDirect weapon damage is not absorbed by this Shield and is applied directly to the hull of the ship.",
    ...
    TID_NOTIFICATIONS_ONLY_ON_MOBILE_LABEL: "Notifications will only be delivered if you associate your Account with a mobile device.",
    ...
    TID_ACCOUNT_LINK_INFO_TEXT: "Your Account will be bound to your Hades' Star game. To access your game from another device, just sign in with the same Account.",
    TID_GUEST_MODE_BUTTON: "Guest Mode",
    TID_GUEST_MODE_WARNING: "Entering Guest Mode means your Account will not be bound to your Hades' Star game. Your progress will only be saved locally, and will be lost if you uninstall the game. You can safeguard your progress and bind your Account later from the Settings menu.\\n\\nProceed with Guest Mode?",
};
