...
export default {
    ...
    TID_MODULE_REMOTE_REPAIR: "REMOTE REPAIR",
    ...
    TID_MODULE_LASER_DESCR: "A single-target weapon that fires a laser beam against the enemy. The beam starts out weak, but will move to higher stages of damage the longer it stays locked to the same target. Damage will reset to the base value when the weapon switches targets or stops firing.",
    ...
    TID_MODULE_DUAL_LASER_DESCR: "Fires a laser beam against up to two enemies within range. The damage the two beams apply will ramp up to higher stages in lockstep, while both beams stay locked to an active target. Damage will reset to the base value when there are less than two enemy targets in range.",
    ...
    TID_SECURITY_RATING_1: "Partially Secure",
    TID_SECURITY_RATING_0_DESCR: "No combat between player-controlled forces can take place in this star system. Ships lost to combat with Cerberus will return to a safe planet.",
    TID_SECURITY_RATING_1_DESCR: "No combat between player-controlled forces can take place in this star system. Ships lost to combat with Cerberus ships will jump home safely. Ships lost to Supernova will be lost permanently.",
    TID_SECURITY_RATING_2: "Partially Secure",
    TID_SECURITY_RATING_2_DESCR: "Your ships will open fire against any ships that belong to players from other Corporations. Ships lost to combat will jump home safely. Ships lost to Supernova will be lost permanently.",
    TID_SECURITY_RATING_3: "Secure",
    TID_SECURITY_RATING_3_DESCR: "Your ships will open fire against all other players' ships. Ships lost in Blue Stars for any reason will jump home safely.",
    TID_SECURITY_RATING_4: "Not Secure",
    TID_SECURITY_RATING_4_DESCR: "No combat between player-controlled forces can take place in this star system. Ships lost to combat with Cerberus ships, or to Supernova, will be lost permanently.",
    ...
    TID_STARTER_PACK_2_BENEFIT_RESEARCH_TIME: "Upgrade time for all Modules permanently reduced by {0}%.",
    ...
    TID_OBJ_BUILD_TIME_MODULATOR_HINT: "Select a planet level 6 or higher. Select the PRODUCTION command at the bottom of the screen. Scroll down the construction list and select STAR.",
