...
export default {
    ...
    TID_IMPULSE_SHIELD_DESCR: "Immediately after activation, and for a short period of time, the Battleship gains an Impulse effect, allowing it to travel faster and apply constant area damage to all enemy ships in a small area around it. The Impulse effect ends after the Impulse Time expires, or the ship reaches its destination. While Delta Shield is active, it will absorb incoming damage until it is depleted or its timer runs out.\\n\\nThis Shield can only be activated while the Battleship is moving.",
