 ...
 * @OriginalFile raw/Nebula/loc_strings/loc_strings_en.csv
 */
...
export default {
    ...
    TID_CLONED_ASTEROID: "Cloned Asteroid",
    ...
    TID_MSG_CANNOT_JUMP_SHIP_NO_DIPLO: "The owner of this star system does not allow incoming jumps.",
    ...
    TID_START_NEW_GAME: "NEW GAME",
    TID_TRANSFER_EXISTING_GAME: "RECOVER GAME",
    TID_STAR_DISCOVERED_ON_TID_MONTH_YEAR: "Discovered on {0}, {1}",
    TID_DLG_TITLE_ERROR: "ERROR",
    TID_ERROR_MUST_LOGIN_IOS: "You must log in to GameCenter before loading a previous game. Open the iOS Settings app, then scroll down to the GameCenter option.",
    TID_ERROR_MUST_LOGIN_ANDROID: "You must log in with Google Play before loading a previous game.",
    ...
    TID_TUT_OTHER_PLAYERS_IN_RS: "Other players may be operating in Public Red Stars. You can work together to defeat Cerberus ships. There is no combat between player ships in Red Stars.",
    ...
    TID_BUILDING_TRADINGSTATION_DESCR: "Trade Stations create and accept high value Shipments to and from your planets. They must be placed in an empty sector.\\n\\nTrade Stations also allow any player to sell Minerals found in Quantum Stars. The Credits price offered per Mineral item will periodically change and is different across different Yellow Star systems.",
    TID_BUILDING_DIPLOMACY_CENTER: "DIPLOMACY STATION",
    TID_BUILDING_DIPLOMACY_CENTER_DESCR: "Establishes a Jump Gate between your star system and another player's system. Ships from either player can travel across the gate. You can optionally allow third party players to use the gate and send ships through your system.",
    ...
    TID_BLD_RELAY_DESCR: "This optional Station allows you to partially or fully automate Shipment delivery, using Fragments retrieved in Blue Stars. Shipments delivered via the Relay pay a small additional bonus.",
    ...
    TID_MINERAL_ITEM: "REFINED MINERALS",
    ...
    TID_SHIP_BATTLESHIP_DESCR: "A combat ship that can be highly customized with additional Weapon and Shield modules.",
    ...
    TID_SHIP_CERB_GHOSTS: "CERBERUS DRONES",
    TID_SHIP_CERB_GHOSTS_DESCR: "A group of fast ships that jump in unpredictably and move collectively to the nearest target, anywhere in the star system.\\n\\nCerberus Drones are immune to all modules that don't do damage, and do not count as ships for certain modules like Barrage and Salvage.",
    ...
    TID_SHIP_CERB_CARRIER_DESCR: "This fearsome juggernaut can target up to 8 enemy ships with its independently scaling lasers. It will regularly spawn groups of Sentinels, and can strategically Teleport to stay in the heat of combat.",
    ...
    TID_GHOST_SPAWNER: "Drone Jumpgate",
    TID_GHOST_SPAWNER_DESCR: "This mysterious gate is used by Cerberus Drone ships to jump to new star systems. The gate cannot be targeted or used as a move target.",
    TID_MODULE_TRADER: "TRADE BOOST",
    TID_MODULE_TRADER_DESCR: "While active, every Credit shipment delivery will increase its payout by a set bonus amount. The bonus can stack with other shipping modules.",
    ...
    TID_MODULE_MINING_BOOST_DESCR: "While this Module is active, the Miner collects Hydrogen at a significantly faster rate.",
    TID_MODULE_EMP: "EMP",
    TID_MODULE_EMP_DESCR: "Disables all hostile ships, rockets and drones within the affected area for a short period of time. Disabled ships do not move or fire, but can still activate Modules. They will also have their target reset.",
    ...
    TID_MODULE_TIME_WARP_DESCR: "Speeds up Module time for all friendly and enemy ships in range. Sped up Modules deal increased damage per second and have shorter cooldowns, but Activated modules will have their activation times reduced.\\n\\nA ship in range of multiple Time Warps is only affected by the highest level one.",
    ...
    TID_MODULE_LASER_DESCR: "A single-target weapon that does increasingly higher damage the longer it stays focused on its target. Damage will reset when the weapon switches targets or stops firing.",
    ...
    TID_HYDRO_STORAGE_CAPACITY: "HYDROGEN BAY EXTENSION",
    TID_HYDRO_STORAGE_CAPACITY_DESCR: "Increases the maximum amount of Hydrogen that a Miner ship can carry.",
    TID_MINERAL_EXTRACTOR: "MINERAL EXTRACTOR",
    TID_MINERAL_EXTRACTOR_DESCR: "Allows the miner ship to extract Minerals from Mineral fields. Extracted Minerals are stored with the module.\\n\\nWhen deposited to a planet, the Minerals will be converted to Mineral Shipments. ",
    ...
    TID_MODULE_STEALTH_DESCR: "While the effect is active, the owner ship cannot be directly targeted by enemy weapons. It will still take Area Damage if within blast range. While Stealthed, the owner ship will still be able to fire on enemy targets.",
    ...
    TID_MODULE_SOLITUDE_DESCR: "Greatly increases damage output for the owner's ship weapon when there are no other friendly ships in the sector (including ships from other players).\\n\\nCan only be equipped on Battleships.",
    ...
    TID_MODULE_HYDRO_CLONE: "HYDROGEN CLONE",
    TID_MODULE_HYDRO_CLONE_DESCR: "Creates a cloned duplicate for each Hydrogen asteroid in the Miner's current sector. The clone's Hydrogen amount depends on the amount stored on the original Asteroid, and the module's upgrade level. The clones have a limited lifetime and will disappear shortly after their creation.",
    TID_MODULE_FORTIFY: "FORTIFY",
    TID_MODULE_FORTIFY_DESCR: "While the effect is active, all damage taken by the ship is reduced by a fixed percentage rate. The activating ship is immediately immobilized and is unable to move for the entire duration.\\n\\nCerberus ships prefer firing on the Fortified ship over all other potential targets, and will switch from their old target immediately if the activating ship is within range.",
    TID_MODULE_SALVAGE: "SALVAGE",
    TID_MODULE_SALVAGE_DESCR: "Instantly heals a fixed amount of hull strength each time any enemy combat ship (not including Drones) is destroyed in the same sector. The heal amount is equal to MAX HEAL AMOUNT divided by the number of friendly ships with SALVAGE in the same sector.",
    ...
    TID_MODULE_BARRIER_DESCR: "Creates a force field around the ship. Enemy ships and most rocket types cannot move while inside the force field. Enemy ships cannot use any object inside the effect area as a target for the Teleport module. Does not affect Drones.",
    ...
    TID_MODULE_TRADE_BURST_DESCR: "Counts shipments delivered during the activation period. After a minimum threshold is met, every new Credits shipment delivered by the owner ship while the module is still active will yield a bonus reward. The bonus can stack with other shipping modules.",
    ...
    TID_MODULE_RUSH_DESCR_RS: "Increases the speed of the owner Transport ship when it carries any Artifacts that originated in the current Red Star. The speed increase is proportional to the number of Artifacts carried.",
    ...
    TID_MODULE_GENESIS_DESCR: "Instantly creates new asteroid fields inside the Miner's current sector, and close to the Miner's location.",
    TID_MODULE_ENTRUST: "ENTRUST",
    TID_MODULE_ENTRUST_DESCR: "Allows the owner transport ship to instantly teleport its cargo to another transport ship or Relic Drone in range. Works with Shipments and fully loaded Artifacts and Relics.",
    ...
    TID_MODULE_SUSPEND_DESCR: "Reduces movement speed for all enemy ships in range. Also reduces the effectiveness of any active Time Warp module within the effect area.\\n\\nAn object in range of multiple Suspend areas is only affected by the highest level one.",
    ...
    TID_MODULE_PULSE_DESCR: "A Pulse periodically applies around the Battleship's current location, dealing massive area damage to all enemy ships in range. The Pulse needs a long cooldown time to recharge, but can be sped up with Time Warp.",
    ...
    TID_MODULE_ARTIFACT_BOOST_DESCR: "Increases the Research Bonus output for the first non boosted Artifact in the target Red Star planet. The Artifact must be originating in the current Red Star. This Bonus can never be applied more than once per Artifact. Will not apply to Artifacts currently being loaded on Transports.",
    ...
    TID_TRADEITEM_ARTIFACT_COMBAT: "ORB",
    TID_TRADEITEM_ARTIFACT_UTILITY: "CUBE",
    TID_TRADEITEM_ARTIFACT_SUPPORT: "TETRAHEDRON",
    ...
    TID_ACHIEVEMENT_COMMONHYDRO_DESCR: "Collect {0} Hydrogen from asteroid fields.",
    ...
    TID_HUD_PICK_WEAPON_LINK_TARGET: "SELECT WEAPON LINK TARGET",
    ...
    TID_HUD_WEAPON_DPS_DISPLAY: "DPS: {0}",
    ...
    TID_STATUS_DESTROYING_MINERAL_FIELD: "Destroying Mineral Field",
    ...
    TID_ASTEROID_MINERALS_REMAINING: "<sprite name=''minerals''> <color>{0}</color> remaining",
    ...
    TID_DIPLO_OPEN_SYSTEM_LBL: "OPEN YELLOW STAR SYSTEM",
    TID_DIPLOMACY_PERMISSIONS_DLG_TITLE: "DIPLOMACY PERMISSIONS",
    TID_DIPLOMACY_OPEN_SYSTEM: "Open Star System",
    TID_DIPLOMACY_OPEN_SYSTEM_DESCR: "Setting your Yellow Star to Open allows potentially any player to visit, via one of your diplomacy partners' gates. Use this feature to encourage other players to sell Minerals in your Trade Stations, when your local prices are high. You will receive a comission for each sale.",
    TID_DIPLO_STATUS_OPEN_DESCR: "Open to the Hades Galaxy.",
    TID_DIPLO_STATUS_CLOSED_DESCR: "Only allowing direct diplomacy partners.",
    TID_PERMISSIONS_TITLE: "Allowed activities for visitors to this Star:",
    TID_PERMISSION_MINING: "MINING",
    ...
    TID_DIPLO_HYDRO_REMAINING: "Hydrogen Amount Remaining: {0}",
    TID_DIPLO_HYDRO_COOLDOWN: "Permission available in {0}",
    ...
    TID_CORP_LEADER_ROTATION_WARNING_MAIL: "First Officer {0} has been inactive for an extended period of time. If they remain inactive a new First Officer will be appointed.",
    TID_CORP_LEADER_ROTATION_NOTIFY_MAIL: "{0} has been appointed First Officer due to inactivity of the previous First Officer.",
    TID_CORP_INACTIVITY_MAIL: "Your Corporation has been inactive for an extended period of time. Consider <style=Link><link=''__joincorp''>joining a new Corporation</link></style> that is more active!",
    ...
    TID_PLAYER_INFO_INFLUENCE_DESCR: "Influence indicates a player's capability in Red Stars. Upgrading to higher Red Star levels and teaming up with other strong players can help climb the Influence leaderboard.",
    ...
    TID_OTHER_PLAYER_FRIEND_REQUEST: "ADD TO FRIENDS",
    ...
    TID_FRIEND_REQUEST_OTHER_PLAYER_INBOX_FULL: "Cannot send request, player's inbox is full",
    TID_FRIEND_REQUEST_ALREADY_WAITING_FOR_RESPONSE: "Cannot send request, already waiting for a response from this player",
    TID_FRIEND_REQUEST_ALREADY_INVITE_FROM_TARGET: "Cannot send request, already have a pending invite from this player",
    TID_FRIEND_REQUEST_MAX_REQUESTS_TODAY: "Cannot send anymore friend requests today",
    TID_FRIEND_REQUEST_MAX_REPEAT_REQUESTS_TODAY: "Cannot send anymore friend requests to this person today",
    TID_FRIEND_REQUEST_TARGET_PLAYER_BLOCKED: "You cannot send a request to a player you have blocked",
    TID_FRIEND_REQUEST_BLOCKED_BY_REQUEST_TARGET: "You cannot send this person a friend request",
    TID_FRIEND_REQUEST_DECLINED_INBOX_MESSAGE: "Your Friendship request to {0} has been declined.",
    ...
    TID_FRIEND_REMOVED_INBOX_MESSAGE: "Your friendship with {0} has ended",
    ...
    TID_TRADE_DLG_TITLE_QUANTUM_STAR: "MINERALS",
    TID_TRADE_DLG_TITLE_MINERALS_TITLE: "MINERALS ON PLANET",
    TID_NO_SHIPMENTS_QUANTUM_STAR: "No Minerals available.",
    ...
    TID_SHOW_UPGRADEABLE_ONLY_TOGGLE: "UPGRADEABLE MODULES ONLY",
    ...
    TID_MODULE_BLUEPRINTS_LOCKED_MODULE_INFO: "Research more {0} Artifacts (Level {1} or higher) for a chance to discover this Module.",
    ...
    TID_BUY_ARTIFACT_DLG_DESCR_ORB: "Researching ORB Artifacts will yield Blueprints for WEAPON and SHIELD modules.",
    TID_BUY_ARTIFACT_CONFIRM: "Buy this Artifact now?",
    TID_BUY_ARTIFACT_DLG_DESCR_CUBE: "Researching CUBE Artifacts will yield Blueprints for TRADE or MINING modules.",
    TID_BUY_ARTIFACT_DLG_DESCR_TETRAHEDRON: "Researching TETRAHEDON Artifacts will yield Blueprints for SUPPORT modules.",
    ...
    TID_RESEARCH_YIELD_TITLE: "RESEARCH YIELDS:",
    ...
    TID_MODULE_REPAIR_STAT: "TOTAL HP REPAIRED",
    ...
    TID_MODULE_DESCR_DPS_AREA: "AREA DAMAGE PER SECOND",
    ...
    TID_MODULE_DESCR_SOLITUDE: "DAMAGE INCREASE",
    ...
    TID_INFO_MODULES_OPEN_TECH_WINDOW: "<style=Link><link=''tech''>Open MODULES Window</link></style>",
    ...
    TID_MODULE_RUSH_SPEED_INCR_VAL_PER_SHIPMENT_RS: "+{0}% / ARTIFACT",
    ...
    TID_MODULE_HYDRO_CLONED_AMT: "CLONED AMOUNT",
    TID_MODULE_HYDRO_CLONE_LIFETIME: "CLONE LIFETIME",
    TID_MODULE_IMPULSE_SPEEDUP: "SPEED BOOST",
    ...
    TID_RS_DIALOG_NEW_STAR_TAB: "NEW",
    TID_RS_DIALOG_EXISTING_STAR_TAB: "EXISTING",
    TID_RS_DIALOG_FEATURED_STAR_TAB: "FEATURED",
    ...
    TID_MISSIONS_DLG_SEARCHING_HINT_14: "CUBE Artifacts contain Blueprints for modules that increase efficiency of your Transport and Miner ships.",
    ...
    TID_RS_HYDRO_SPENT_AREA_HINT: "The total amount of Hydrogen spent on your last Red Star run, compared to the average amount of Hydrogen spent by all players who played the same Red Star level.",
    ...
    TID_JOIN_DARK_RED_STAR_TOGGLE: "Search for Dark Red Star",
    TID_DARK_RED_STAR_LABEL: "DARK RED STAR",
    TID_JOIN_DARK_RED_STAR_INFO: "Dark Red Stars provide better rewards, but are also guarded by stronger versions of Cerberus ships.\\n\\nYou cannot jump any ship equipped with SANCTUARY to a Dark Red Star.\\n\\nUp to 2 players can operate together in a Dark Red Star.",
    TID_RS_LATE_JOIN_NO_STARS: "No existing red stars available to join.",
    TID_CONFIRM_DARK_RED_STAR: "You will not be able to jump any ships equipped with SANCTUARY to a Dark Red Star. Are you sure you want to proceed?",
    TID_FEATURED_RS_TITLE: "FEATURED STARS",
    TID_FEATURED_RS_RED_STARS: "RED STARS",
    TID_FEATURED_RS_DARK_RED_STARS: "DARK RED STARS",
    TID_FEATURED_RS_LEVEL: "Level {0}",
    TID_EXISTING_RS_PRIVATE: "PRIVATE",
    ...
    TID_RELAY_FRAGMENTS_INFO: "The amount of Fragments that are currently stored on the Relay. Fragments are needed to power this Station. Participate in Blue Stars to earn more Fragments.",
    TID_RELAY_SECTORS_INFO: "The amount of Sectors the Relay is currently active on. Upgrade to increase the maximum allowed Sectors.",
    ...
    TID_MINERAL_ASTEROID_FIELD: "Mineral Field",
    ...
    TID_FLEET_MINERAL_EXPIRY: "MINERAL EXPIRY",
    TID_FLEET_MINERAL_EXPIRY_DESCR: "The time remaining until at least one Mineral item aboard this ship expires.",
    ...
    TID_FLEET_MINERAL_CAPACITY: "MINERAL STORAGE USED",
    TID_FLEET_MINERAL_CAPACITY_INFO: "When your Mineral storage is fully used, return the ship to any of your planets to deposit the Minerals.",
    ...
    TID_ASTEROID_FIELD_MINERALS_REMAINING: "MINERALS ON THIS ASTEROID",
    ...
    TID_REDSCANNER_OPTIMAL_INFLUENCE_DESCR: "Success in maximum level Red Stars allowed by this Scanner will yield the most Influence gain if the player's influence is lower than this value.",
    ...
    TID_RELAY_BONUS_PCT: "DELIVERY BONUS",
    TID_RELAY_BONUS_PCT_DESCR: "The additional bonus to the Credit paypout that will be applied when a shipment is delivered via the Relay.",
    ...
    TID_MINERAL_SELL_PRICE: "MINERAL SELL PRICE",
    TID_MINERAL_SELL_PRICE_DESCR: "The price in Credits you will be awarded per Mineral item, when bringing a transport loaded with Minerals to this station.",
    TID_MINERAL_PRICE_REFRESH: "MINERAL PRICE REFRESH",
    TID_MINERAL_PRICE_REFRESH_DESCR: "The time until the Mineral Sell Price will change for all Trade Stations in this star system.",
    TID_FLEET_MAX_TARGETS: "MAXIMUM TARGETS",
    TID_CUSTOMIZE_OBJECT: "CUSTOMIZE",
    TID_CUSTOMIZE_PLANET_INFO: "Select a new permanent appearance for this Planet.",
    TID_CUSTOMIZE_STAR_INFO: "Select a new permanent appearance for this Star.",
    TID_APPLY_PLANET_CUSTOMIZATION_CONFIRM: "Permanently apply this new appearance to the Planet?",
    TID_APPLY_STAR_CUSTOMIZATION_CONFIRM: "Permanently apply this new appearance to the Star?",
    ...
    TID_STARTER_PACK_BENEFIT: "Build prices for all ships and upgrade prices for all ships permanently reduced by {0}%.",
    TID_STARTER_PACK_2: "STARTER PACK 2",
    TID_STARTER_PACK_2_BENEFIT_RESEARCH: "Upgrade time for all Modules permanently reduced by {0}%.",
    TID_STARTER_PACK_2_BENEFIT_PLANETS: "Upgrade time for all Planets permanently reduced by {0}%.",
    ...
    TID_CHAT_ENTRY_ABORTED_RED_STAR_SEARCH: "Red Star Search cancelled.",
    ...
    TID_STAR_GOALS_DESCR_OTHER_PLAYER_HOMESTAR: "This star belongs to another player. If you have diplomatic relations with this player you can send a limited number of ships here to trade Minerals or help the owner player against Cerberus forces.",
    ...
    TID_RS_PROGRESS_BAR_HELP: "Destroying Cerberus ships and transporting Artifacts out of the Red Star will increase the Score Bar. Fill the bar at least until the marked Threshold to gain Influence from this Red Star. The Threshold will increase as you gain more Influence.\\n\\nInfluence is gained only by players who contribute by doing damage to Cerberus ships or by taking Artifacts. Until you contribute, the Score Bar will display faded out.",
    ...
    TID_SHIPMENT_ECONOMY_POPUP: "Indicates the current amount of Credits stored in Shipments on this Star System, compared to the overall amount of Shipment Credits this system generates per day.\\n\\nTo increase your daily Shipment income, regularly upgrade your planets and Trade Stations. A variety of Trade modules can also help significantly boost your actual daily income.",
    TID_ASTEROIDS_ECONOMY_POPUP: "Indicates the current amount of Hydrogen stored in Asteroid Fields on this Star System, compared to the maximum amount of Hydrogen this system's explored sectors can respawn per day. \\n\\nYour options to increase your daily Hydrogen income include exploring additional sectors, allocating more Miner ships, using Mining Modules or taking your Miners to Red Stars.",
    ...
    TID_JUMP_FAIL_DARK_RS_SANCT: "You cannot jump a ship with SANCTUARY to a Dark Red Star.",
    ...
    TID_CORP_LEVELS_PROGRESS_TO_NEXT_LEVEL_INFO: "Collect Relics in White Stars to upgrade your Corporation to the next level. Once you reach the required Relics threshold, the Corporation will be upgraded automatically.",
    TID_CORP_LEVEL_TITLE: "LEVEL {0}",
    TID_CORP_MAX_MEMBERS: "MAX MEMBERS",
    TID_CORP_MAX_MEMBERS_HINT: "The maximum amount of members the Corporation can accept. Having more members will increase your Corporation Influence score.",
    ...
    TID_CORP_ARTIFACT_YIELD_BONUS: "ARTIFACT BONUS",
    TID_CORP_ARTIFACT_YIELD_BONUS_HINT: "When you start a Private Red Star search within this Corporation, the Artifacts found in the Red Star will have a bonus applied to their research.",
    ...
    TID_FCMD_LINK_WEAPON: "LINK WEAPON",
    TID_FCMD_UNLINK_WEAPON: "UNLINK WEAPON",
    ...
    TID_OBJ_LEVELABLE: "SCALABLE OBJECTIVE",
    TID_OBJ_LEVEL_INFO: "Finishing this Objective within the time limit will unlock higher level versions, with higher Rewards.\\n\\nCurrent Objective level: {0}/{1}",
    ...
    TID_USE_TRADEBOOST_HINT: "Unlock the TRADE BOOST or TRADE BURST Module and install it on your Transport ship. Use the Transport ship to deliver shipments while the installed Module is activated.",
    ...
    TID_OBJECTIVE_BLS_DETAILS: "Blue Stars are optional. If you choose to participate regularly, you can improve your economy and automate Shipments in your home star via the SHIPMENT RELAY station.",
    TID_OBJECTIVE_DRS_DETAILS: "Dark Red Stars offer a bigger challenge and more rewards. You cannot take any ship equipped with SANCTUARYT to a Dark Red Star.",
    ...
    TID_USE_DESTINY_NO_SANCT: "Use DESTINY on a Red Star level {0} or higher. The ship must not be equipped with SANCTUARY.",
    ...
    TID_USE_ALPHA_ROCKET: "Deal a total of {0} damage to enemy ships using ALPHA ROCKET.",
    ...
    TID_OBJ_SECOND_SRS_HINT: "Select a planet level 3 or higher. Press the PRODUCTION button at the bottom of the screen. Scroll down the construction list and select SHORT RANGE SCANNER.",
    TID_OBJ_BUILD_TIME_MODULATOR_DESCR: "Build a Time Modulator Station.",
    TID_OBJ_BUILD_TIME_MODULATOR_HINT: "Select a planet level 6 or higher. Press the PRODUCTION button at the bottom of the screen. Scroll down the construction list and select TIME MODULATOR.",
    ...
    TID_OBJ_INSTALL_MODULE_DESCR: "Unlock the BATTERY weapon and install it on a Battleship.",
    TID_OBJ_INSTALL_ALPHA_SHIELD: "INSTALL ALPHA SHIELD",
    TID_OBJ_INSTALL_ALPHA_SHIELD_DESCR: "Unlock the ALPHA SHIELD module and install it on a Level 2 Battleship.",
    ...
    TID_OBJ_PROGRAM_MINER_HINT: "Select your Miner. At the bottom of the screen, select the SET MINING ROUTE button. Select the sectors you want your miner to cover.",
