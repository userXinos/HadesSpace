...
export default {
    ...
    TID_MODULE_AREA_SHIELD_DESCR: "Absorbs hull damage taken by every other friendly Ship, Drone or Rocket in the effect area. The activating Battleship itself is not covered by the Shield.",
    ...
    TID_MODULE_BLAST_SHIELD_DESCR: "Protects the owner ship against Area Damage only. Direct weapon damage is not absorbed by this Shield and is applied directly to the hull of the ship.",
    ...
    TID_MODULE_FLAGSHIP_SHIELD_DESCR: "A stand-alone Area shield with a fixed position that can be deployed from the Corporation Flagship. Absorbs hull damage taken by any friendly Ship, Drone or Rocket in the effect area.",
    ...
    TID_TEMP_1: "Cannot jump this ship. Use the Scanner to create a ship specifically for Early Access.",
    TID_TEMP_2: "This Early Access ship can only jump to the Star Type it was created for.",
