...
export default {
    ...
    TID_CROSS_PLAY_NOTE_XBOX: "Hades' Star allows you to play with your friends and other players across Xbox Live and other multiplayer networks.",
    TID_XBOX_LIVE_ACCOUNT: "Xbox Live Account",
    TID_PSN_ACCOUNT: "PlayStation® Network Account",
    ...
    TID_CONNECTION_ERROR_XBL_MULTIPLAYER_PRIVILEDGE: "You need Xbox Live Multiplayer access in order to play Hades' Star.",
    ...
    TID_GAMEPAD_ACTION_MOVE_HERE: "Move Ship Here",
    TID_GAMEPAD_ACTION_CONFIRM_DEPART: "Confirm Departure",
    TID_GAMEPAD_ACTION_CANCEL_DEPART: "Cancel Departure",
    TID_GAMEPAD_ACTION_ADD_WAYPOINT: "Add Waypoint",
};
