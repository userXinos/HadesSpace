...
export default {
    ...
    TID_MODULE_REDSTAR_EXTENDER_DESCR: "Adds a small amount of time to a Red Star's life when activated within the star's sector.",
    ...
    TID_SANCTUARY_DELETED_INFO: "The SANCTUARY module has been uninstalled from all your ships. All ships will now return home safely when destroyed from combat in any star type, except when they are in the new Dark Red Stars. Ships caught in a Supernova in a Red or White star will still be lost permanently.\\n\\nFor more information, see blog.hadesstar.com.",
    ...
    TID_MISSIONS_DLG_DRS_SEARCH_SOLO: "Solo",
    TID_MISSIONS_DLG_DRS_SEARCH_SOLO_DESCR: "No other players can join this Dark Red Star.",
    TID_MISSIONS_DLG_DRS_SEARCH_TEAM: "Team",
    TID_MISSIONS_DLG_DRS_SEARCH_TEAM_DESCR: "Corporation members can join this Dark Red Star. For every new join, you can send one less Battleship to the Dark Red Star.",
    TID_MISSIONS_DLG_JOIN_CORP_PROMPT: "<style=Link><link=''__joincorp''>Join a Corporation</link></style> to unlock private Red Stars.",
    TID_MISSIONS_DLG_JOIN_CORP_DRS_PROMPT: "<style=Link><link=''__joincorp''>Join a Corporation</link></style> to unlock Team Dark Red Stars.",
    ...
    TID_CHAT_ENTRY_STARTED_DARK_RED_STAR_SEARCH: "has started a Level {0} Dark Red Star Search",
