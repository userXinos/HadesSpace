...
export default {
    ...
    TID_MODULE_ROCKETDRONE_DESCR: "Launches a slowly moving Drone towards the destination location. During its limited lifetime, the drone will launch Drone Rockets towards its closest enemy at regular intervals.",
    ...
    TID_ACHIEVEMENT_DAILY_REWARDS_DESCR: "Collect your Daily Rewards {0} day(s) in a row.",
    ...
    TID_RS_DIALOG_INFLUENCE_REWARDS_TOOLTIP: "Every Red Star can award or take away EMPIRE POWER points. To gain EMPIRE POWER, destroy enough Cerberus ships and take Artifacts to meet the score Threshold displayed under the star icon.",
    TID_RS_INFLUENCE_REWARD_VICTORY: "VICTORY",
    TID_RS_INFLUENCE_REWARD_DEFEAT: "DEFEAT",
    TID_RS_CURRENT_INFLUENCE: "CURRENT EMPIRE POWER",
    ...
    TID_CHAT_ENTRY_CORP_LEADER_ROTATION_WARNING: "First Officer {0} has been inactive for an extended period of time. If they remain inactive a new First Officer will be appointed.",
    TID_CHAT_ENTRY_CORP_LEADER_ROTATION_EXECUTED: "{0} has been appointed First Officer due to inactivity of the previous First Officer.",
    ...
    TID_CORP_ARTIFACT_YIELD_BONUS_HINT: "When you start a Private Red Star search within this Corporation, the Artifacts found in the Red Star will have a bonus applied to their research. To maintain the maximum possible bonus, the Corporation needs to win a White Star regularly.",
    ...
    TID_ARTIFACT_BONUS_CORP_HINT: "The current Bonus applied to Artifacts retrieved in Private Red Stars. Applies to Red Star searches initiated by any member of this Corporation.",
