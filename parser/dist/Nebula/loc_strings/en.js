...
export default {
    ...
    TID_MODULE_MASS_MINING_DESCR: "While active, the Miner collects Hydrogen from all Asteroid Fields in the sector simultaneously. The speed modifier applies to each Asteroid Field individually. Total mining speed is proportional to the total amount of Asteroid Fields in the sector.",
    ...
    TID_MASSMINE_INVALID_SECTOR: "This module requires more Asteroids in the current sector before it can be activated.",
