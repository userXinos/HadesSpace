...
export default {
    ...
    TID_BUILDING_TRADINGSTATION_DESCR: "Trade Stations create and accept high value Shipments to and from your planets. They must be placed in an empty sector, not adjacent to sectors that contain other Trade Stations.",
    ...
    TID_MODULE_REDSTAR_EXTENDER_DESCR: "Adds extra time to a Red Star's life, when activated within the star's sector. The Miner needs to have enough Hydrogen on board for at least 1 extra second of lifetime.",
    ...
    TID_MODULE_BLUEPRINTS_LIST_CATEGORY_MINING: "MINER",
    ...
    TID_MODULE_BLUEPRINTS_LOCKED_MODULE_INFO: "Research more {0} Artifacts (Red Star Level {1} or higher) for a chance to discover this Module.",
    ...
    TID_BUY_ARTIFACT_DLG_DESCR_CUBE: "Researching CUBE Artifacts will yield Blueprints for TRANSPORT or MINER modules.",
    TID_BUY_ARTIFACT_DLG_DESCR_TETRAHEDRON: "Researching TETRAHEDON Artifacts will yield Blueprints for COMBAT modules.",
    ...
    TID_MODULE_RED_STAR_EXTENSION_STAT: "LIFE EXTENSION PER 500 HYDROGEN",
    ...
    TID_SHIP_MODULE_SLOT_TYPE_1: "Miner",
    ...
    TID_MISSIONS_DLG_SEARCHING_HINT_15: "TETRAHEDRON Artifacts contain Blueprints for powerful Combat modules that can be equipped on Battleships.",
