...
export default {
    ...
    TID_MODULE_MASS_MINING_DESCR: "While active, the Miner collects Hydrogen simultaneously from its current Asteroid and additional Asteroid Fields in its sector. The collection speed per single Asteroid is reduced, causing the Miner to collect slower if there is only a single Asteroid in the sector, or significantly faster if there are many.\\n\\nWhen picking the extra Asteroid fields, the highest capacity, non-scanned fields are given higher priority.\\n\\nThe maximum number of extra Asteroid fields the Miner can collect from depends on the module's upgrade level.",
    ...
    TID_MODULE_ENRICH_DESCR: "Instantly increases the amount of Hydrogen stored on all asteroids in the sector. Cannot be used on the same sector more than once per day.",
    ...
    TID_RELAY_PAYOUT: "You will receive <sprite name=''cr''> <c1>{0}</color> , including <sprite name=''cr''> <c1>{1}</color> bonus.",
    ...
    TID_RELAY_BONUS_PCT_DESCR: "The maximum additional bonus to the Credit paypout that will be applied when a shipment is delivered via the Relay.",
    ...
    TID_STARTER_PACK_2_BENEFIT_SHIPMENT_INCOME: "Credit rewards for all Planet, Moon and Trade Station Shipments permanently increased by {0}%.",
    ...
    TID_NOTIFICATIONS_ONLY_ON_MOBILE_LABEL: "Notifications will only be delivered if you Link your Account with a mobile device.",
    ...
    TID_OBJ_LEVEL_INFO: "Finishing this Objective within the time limit can unlock higher level versions, with higher Rewards. Higher level versions may not appear unless you also upgrade to a higher Red Star Scanner level.\\n\\nCurrent Objective level: {0}/{1}",
    ...
    TID_DN_HYDRO_CAP_CHANGED: "Your Hydrogen capacity has been changed. Hydrogen capacity now roughly represents the amount of Hydrogen your Empire is expected to produce and consume during a day.\\n\\nCollect the available Hydrogen from Asteroid Fields in your Yellow Star system and use it to deliver Shipments and jump ships to Red Stars. Battleships and most Modules no longer consume Hydrogen.",
    TID_DN_MODULE_CHANGES: "The following Modules were replaced by new ones. Your previous progress with these Modules has been transferred over to the new ones. Open the MODULES screen for details and videos of how Modules now work.",
