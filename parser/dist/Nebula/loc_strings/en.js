...
export default {
    ...
    TID_UNLINK_PSN_INFO: "This process will unlink your PlayStation® Network identity from the current Hades' Star game. You will lose access to your current game ({0}, Level {1}) forever. You will have the option to start a new game.",
    ...
    TID_CONSOLES_GO_BACK_BTN_PROMPT: "Press <sprite index={0}> to go back.",
    ...
    TID_PSN_FRIENDS_LIST: "PLAYSTATION® NETWORK FRIENDS",
