...
export default {
    ...
    TID_MODULE_MASS_MINING_DESCR: "While active, the Miner collects Hydrogen from extra Asteroid fields in the current sector at a reduced collection speed, in addition to the asteroid field it is docked with.\\n\\nWhen picking the extra Asteroid fields, the highest capacity, non-cloned fields are given higher priority.\\n\\nThe maximum number of extra Asteroid fields depends on the module's upgrade level.",
    ...
    TID_MODULE_LEAP_DESCR: "The owner ship initiates teleportation to the closest ally Battleship or Drone engaged in combat against an enemy player ship (not including combat against Cerberus ships). After the activation delay period, and if the targeted ally is still alive, the owner ship will jump to the object closest to the ally ship. After the jump, Area Damage is applied around the owner ship. Both the owner ship and the ally ship are also disabled for a small period of time.\\n\\nCannot be used in Red Stars.",
    ...
    TID_MODULE_CRUNCH_DESCR: "Instantly collects Hydrogen from all asteroid fields in the current sector (limited by the Max Amount and the Miner ship's total capacity). The Hydrogen is collected from the highest capacity Asteroids first. Any cloned Asteroid fields will be considered last.",
    ...
    TID_CORP_INFLUENCE_INFO: "A Corporation's Influence is derived from its member's individual Influence scores. This number is used for the Corporation Influence Leaderboard.",
    ...
    TID_CORP_FLAGSHIP_LEVEL_INFO: "A Corporation's Flagship level indicates the maximum level either of the Corporation's Flagships has been upgraded to.",
    ...
    TID_SHOW_UPGRADEABLE_ONLY_TOGGLE: "ONLY UPGRADEABLE",
    TID_SHOW_UNLOCKED_ONLY_TOGGLE: "ONLY UNLOCKED",
    ...
    TID_BUY_ARTIFACT_DLG_DESCR_ORB: "Researching ORB Artifacts will yield Blueprints for WEAPON or SHIELD modules.",
    ...
    TID_MODULE_MASS_MINING_EXTRA_ASTEROIDS: "MAX EXTRA ASTEROIDS",
    TID_MODULE_MASS_MINING_REMOTE_RATE: "REMOTE COLLECTION SPEED",
    ...
    TID_REDSCANNER_HYDRO_SEARCH_COST_DESCR: "The amount of Hydrogen it takes to start a scan for a Red Star of any level.",
    ...
    TID_WS_LABEL_REWARDS_PROGRESS_DESCR: "Increase the Economic Activity bar by depositing <#8C65FEFF>Hydrogen</color> on planets, or transferring <#FFB800FF>Relics</color> out of the system.\\n\\nFill the activity bar and win this White Star to maximize your Corporation XP reward.",
    ...
    TID_WS_ECONOMY_BAR_HINT: "Depositing Hydrogen on planets and retrieving Relics will increase your Corporation's Economic Activity bar. Fill the bar as much as possible to get higher Corporation XP rewards at the end of the match. Your Corporation XP reward will be significantly higher if you win the match.",
    ...
    TID_NEW_OBJECTIVE_RUSH_CONFIRM: "Are you sure you want to replace this Objective with a new one? You will lose all potential rewards from completing the Objective.",
    ...
    TID_TEMP_1: "Cannot jump this ship. Use the White Star Scanner to create a ship for White Star Early Access.",
    TID_TEMP_2: "This ship can only jump to White Stars.",
};
