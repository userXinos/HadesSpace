...
export default {
    ...
    RedStar: {
        ...
        Star: "RedStar",
        HydrogenSearchCost: [0, 50, 75, 150, 250, 400, 900, 1400, 1800, 2500, 3500, 10000, 30000],
        JumpCosts_T: [
            10,
            [5, 5, 20],
            [10, 10, 10, 10, 20],
            ...
            [500, 500, 800, 800, 1500, 1500, 2000],
            [750, 750, 1000, 1000, 1200, 1200, 1600],
        ...
        JumpCosts_B: [
            ...
            [20, 20, 60, 60, 120],
            [50, 50, 160, 160, 250],
            [50, 50, 50, 350, 350, 600, 1000],
            [100, 100, 100, 600, 1200, 1800],
            [100, 100, 100, 800, 1500, 1700, 2500],
            [100, 100, 100, 1000, 2000, 2000, 5000],
            [100, 100, 100, 5000, 15000],
            [100, 100, 100, 6000, 16000],
            [250, 250, 250, 7000, 18000],
            [1000, 1000, 1000, 10000, 20000],
        ],
        HydroCostModifierPct: [50, 50, 50, 120, 150, 200, 250, 250, 250, 250, 250, 250, 500],
        ...
        InterceptorsToSpawn: [null, null, null, null, 1, 2, 2, 3, 1, 1, 1, 1, 1],
        DestroyersToSpawn: [null, null, null, null, null, null, 4, 4, 4, 4, 5, 5, 5],
        HPBC: [null, null, null, null, null, null, null, [1, 2], [1, 2], [2, 3], [2, 3], [2, 3], [2, 3]],
        LPBC: [null, null, null, null, null, null, null, [1, 1], [1, 1], [1, 1], [1, 2], [1, 2], [1, 2]],
    ...
    WhiteStar: {
        ...
        LQPlanetsPerBracket: 4,
        HAsteroidsClose: 6,
        AstRefreshInfoDisp: [2, 3, 1200, 3200],
        AstRefreshInfoClose: [4, 2, 400, 6800],
    ...
    DarkRedStar: {
        ...
        MaxBattleshipsPerPlayer: [1, 1, 2, 2, 2, 3, 3, 3, 3, 3, 3, 3, 3],
        Star: "DarkRedStar",
        HydrogenSearchCost: [0, 0, 0, 0, 0, 0, 0, 1400, 1800, 2500, 3500, 10000, 30000],
        JumpCosts_T: [
            0,
            0,
            0,
        ...
        HydroCostModifierPct: [0, 0, 0, 0, 0, 0, 0, 250, 250, 250, 250, 250, 500],
        CroidAmt: [0, 0, 0, 0, 0, 0, 0, 150000, 225000, 337500, 450000, 600000, 750000],
        CroidMinDist: [0, 0, 0, 0, 0, 0, 0, 2, 2, 2, 2, 2, 2],
        CroidMaxDist: [0, 0, 0, 0, 0, 0, 0, 3, 3, 3, 3, 3, 3],
        DestroyersToSpawn: [0, 0, 0, 0, 0, 0, 0, 3, 3, 3, 3, 3, 3],
        InterceptorsToSpawn: [0, 0, 0, 0, 0, 0, 0, 3, 1, 1, 1, 1, 1],
        MaxSectorDistanceToMaxPlanet: [0, 0, 0, 0, 0, 0, 0, 3, 3, 3, 3, 3, 3],
        NumMaxPlanets: [0, 0, 0, 0, 0, 0, 0, 3, 3, 3, 3, 3, 3],
        SharedMinPlanet: 0,
        LowerPlanetsMinLevel: [0, 0, 0, 0, 0, 0, 0, 5, 6, 7, 8, 9, 10],
        LowerPlanetsMaxLevel: [0, 0, 0, 0, 0, 0, 0, 6, 7, 8, 9, 10, 11],
        MaxInfluenceLoss: [0, 0, 0, 0, 0, 0, 0, 25, 25, 30, 30, 30, 30],
        MaxInfluenceGain: [0, 0, 0, 0, 0, 0, 0, 120, 150, 180, 240, 260, 300],
        HPBC: [null, null, null, null, null, null, null, [1, 2], [1, 2], [2, 3], [2, 3], [2, 3], [2, 3]],
        LPBC: [null, null, null, null, null, null, null, [1, 1], [1, 1], [1, 1], [1, 2], [1, 2], [1, 2]],
        ArtifactDRSPoints: [null, null, null, null, null, null, null, 1, 2, 4, 6, 10, 20],
        DRSArtifactBonus: 100,
        Influence: [
            0,
            0,
