...
export default {
    ...
    TID_WS_SHIP_UNUSEABLE: "This ship cannot be used outside of White Stars.",
    ...
    TID_SHIP_CERB_DRONE_DESCR: "A modified version of a Cerberus Guardian, with strong hull and a Battery weapon. Uses the same targeting and movement rules as all Cerberus ships. Will attack players indiscriminately, including the Battleship that launched it.",
    TID_MOD_CERB_DRONE_DESCR: "Launches a modified version of a Cerberus Guardian, with strong hull and a Battery weapon. The Drone uses the same targeting and movement rules as all Cerberus ships. It will attack players indiscriminately, including the Battleship that launched it.",
    ...
    TID_STATUS_WS_SHIP_ONLY: "White Star Only ship",
    TID_BTN_HIDE_WS_ONLY_SHIPS: "Hide White Star Only Ships",
    ...
    TID_CORP_ADD_PLAYER_TO_BLOCKLIST_BTN: "BLOCK FROM YOUR CORPORATION",
    TID_CORP_ADD_PLAYER_TO_BLOCKLIST_CONFIRM: "Are you sure you want to block {0} from joining your Corporation?",
    TID_CORP_REMOVE_PLAYER_FROM_BLOCKLIST_CONFIRM: "Are you sure you want to remove {0} from the Corporation's block list?",
    TID_CORP_BLOCKED_LIST_TEXT: "Blocked players will not be able to send new requests to join the Corporation.",
    TID_CORP_STREAM_PLAYER_BLOCKED: "added {0} to the Corporation's block list",
    TID_CORP_STREAM_PLAYER_UNBLOCKED: "removed {0} from the Corporation's block list",
    ...
    TID_RS_DIALOG_DRS_BOOST_TOGGLE: "DISABLE RICH ARTIFACTS",
    TID_RS_DIALOG_DRS_BOOST_TOGGLE_DESCR: "Enabling this setting will instantly disable Rich Artifacts in Dark Red Stars, even when you join a Dark Red Star from another dialog. Use it to control the exact timing you want your daily Dark Red Star Rich artifacts to appear.",
    ...
    TID_RS_DRS_BONUS_DISABLED: "Additional Dark Red Star Artifact Bonus has been manually disabled. Re-enable it from the checkbox below.",
    ...
    TID_LAPSED_ITEM_HEADER: "WELCOME BACK TO HADES' STAR",
    ...
    TID_CHANGE_NAME_PROMPT_2: "Enter the name you want other players throughout the galaxy to know you by.",
    TID_CHANGE_NAME_CONFIRM: "Are you sure you want to change your player name?",
    TID_CHANGE_NAME_WARNING: "WARNING: You will only be able to change your name for free once",
    ...
    TID_EVENT_TITLE_5: "Yellow Star Credits Event",
    TID_EVENT_INFO_5: "While this event is active, all delivered shipments will yield 3x credits.",
    TID_EVENT_TITLE_6: "HADES' STAR COMPLETIST",
    TID_EVENT_INFO_6: "Complete special Objectives by participating in all game modes in Hades' Star. Players who complete the entire sequence of Objectives before the event ends will unlock a unique Distinction on their profile.",
    ...
    TID_COMPLETIST_GOAL_SEQUENCE: "Objective {0}/{1}",
    TID_LAPSED_DLG_TITLE: "WELCOME BACK TO HADES' STAR!",
    TID_LAPSED_DLG_INFO: "Log in every day over the next several days to complete the login reward chain:",
    TID_LAPSED_DISCORD_PROMPT: "Want more information on the game or how to advance faster? Our Discord community can help, join here:",
    TID_OBJ_JOIN_ACTIVE_CORP: "JOIN AN ACTIVE CORPORATION",
    TID_OBJ_JOIN_ACTIVE_CORP_DESCR: "Join a Corporation with at least 10 active members.",
    TID_NEXT_LAPSED_REWARD_AVAILABLE: "Next reward available in {0}",
    TID_LAPSED_REWARDS_EXPIRE: "Reward chain will expire in {0}",
    TID_LAPSED_REWARDS_DAY_COUNTER: "DAY {0}/{1}",
    TID_OBJECTIVE_START_SPECIFIC_ARTIFACT_TITLE: "START RESEARCHING {0}x{1}",
    TID_OBJECTIVE_START_SPECIFIC_ARTIFACT_DESCR: "Start researching a {0}. Repeat {1} times.",
    TID_OBJECTIVE_SALVAGE_SPECIFIC_ARTIFACT_TITLE: "SALVAGE {0}x{1}",
    TID_OBJECTIVE_SALVAGE_SPECIFIC_ARTIFACT_DESCR: "Salvage a {0} Artifact in your Research Station. Repeat {1} times.",
    TID_OBJECTIVE_JOIN_WS: "JOIN A WHITE STAR",
    TID_OBJECTIVE_JOIN_WS_DESCR: "Coordinate with your Corporation members and use your White Star scanner to join a new White Star.",
    TID_OBJECTIVE_COLLECT_WS_POINTS: "COLLECT WHITE STAR POINTS",
    TID_OBJECTIVE_COLLECT_WS_POINTS_DESCR: "Fill the score bar by depositing Hydrogen or using Transports to create Relics and transfer them out of the White Star. Each Relic created or retrieved awards 1 point.",
    TID_OBJ_FULL_PRS: "FULL CORPORATION RED STAR",
    TID_OBJ_FULL_PRS_DESC: "Participate in a full 4 player Red Star that is posted on your Corporation chat page.",
    TID_OBJ_FULL_CLEAR_RS: "RED STAR FULL CLEAR",
    TID_OBJ_FULL_CLEAR_RS_DESCR: "Fully clear a Red Star level {0} or higher. This Objective will be complete if there are no Cerberus ships left at supernova.",
    TID_OBJ_RETRIEVE_ARTS_FROM_DRS: "DARK RED STAR ARTIFACTS",
    TID_OBJ_RETRIEVE_ARTS_FROM_DRS_DESCR: "Retrieve {0} Artifacts from Dark Red Stars level {1} or higher.",
    TID_OBJECTIVE_FLAGSHIP_CONTRIB: "CONTRIBUTE TO FLAGSHIP",
    TID_OBJECTIVE_FLAGSHIP_CONTRIB_DESCR: "Contribute a total of {0} Credits to your Corporation's flaghips.",
    TID_DISTINCTION_COMPLETIST_25: "COMPLETIST",
    TID_DISTINCTION_COMPLETIST_25_DESCR: "This player has completed all objectives in the 2025 Completist Event.",
    TID_DISTINCTION_COMPLETIST_25_DONE: "Congratulations for finishing the Event!",
    TID_OBJ_SHIPMENT_BONUS_REGULAR: "SHIPMENT BONUSES",
    TID_OBJ_SHIPMENT_BONUS_REGULAR_DESCR: "Collect {0} total Credits from Shipment Bonuses. The shipments must be delivered using a Transport ship equipped with modules that give bonuses, or a Shipment Drone.",
    TID_OBJ_SHIPMENT_BONUS_RELAY: "RELAY BONUSES",
    TID_OBJ_SHIPMENT_BONUS_RELAY_DESCR: "Collect {0} total Credits from Shipment Bonuses. The shipments must be delivered using the SHIPMENT RELAY.",
};
