...
export default {
    capital_ships: {
        ...
        darkCerberus: ['DarkSentinel', 'DarkGuardian', 'DarkInterceptor', 'DarkColossus', 'DarkDestroyer', 'DarkBomber', 'DarkPhoenix', 'DarkStorm', 'DarkGhosts', 'DarkHydra', 'DarkHydraling1', 'DarkHydraling2', 'DarkCarrier'],
    },
    planets: {
