...
export default {
    ...
    byPath: [
        ...
        'EMPRocket.AdditionalWaypoint',
        'FlagshipDartBarrage.AdditionalWaypoint',
        'FlagshipClusterRocket.AdditionalWaypoint',
        'FlagshipDartBarrage.SingleTarget',
        'FlagshipDrone.BuildCost',
        'FlagshipDrone.DesignUpgradeCost',
        'FlagshipDrone.DesignUpgradeTimeWS',
