...
export default [
    ...
    'OnDestroySpawn',
    'OnDestroySpawnCount',
    'OnDestroySpawnMinRadius',
    'OnDestroySpawnMaxRadius',
    'SpawnFx',
    'HideModulesOnHUD',
    'MaxPerStarSystem',
    'Damage',
    ...
    'NumMaxPlanets',
    'NumPlayersWithAccess',
    'CRAsteroidAmt',
    'MaxBattleshipsPerPlayer',
    'DestroyersToSpawn',
    'MinBombers',
