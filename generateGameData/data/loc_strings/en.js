...
let data = {
  ...
  TID_MODULE_DELTAROCKET_DESCR:
    "A very fast rocket that does area damage to all enemy ships when it reaches its final destination. can pass through barrier. the owner can optionally set a second waypoint after the launch.\\n\\nenemy ships can fire on the rocket using normal targeting rules. no damage is applied if the rocket is destroyed before it reaches its destination.\\n\\ndoes not work on sectors with jump gates on white stars.",
  ...
  TID_MODULE_DISPATCH_DESCR:
    "The transport ship initiates teleport to the planet with the most items (shipments, artifacts or relics) in the star system. if more than one planets have the same amount of items, the farthest planet is picked.\\n\\nthe teleport completes after the preparation time elapses. the preparation time is proportional to the amount of items on the target planet at the time of activation.",
  ...
  TID_RELIC_DRONE_EVENT_DESCR: "While active, all relics retrieved by relic drone contribute twice to your corporation's total. event ends in N.",
  ...
  TID_BS_FRAGMENTS_REWARD_PROGRESS: "You have participated in N/X ranked matches today.",
  TID_BS_FRAGMENTS_REWARD_FULL: "You will be able to participate in ranked blue star matches again in N.",
  ...
  TID_BLUESCANNER_RANKEDMATCH_COUNTDOWN_DESC: "Indicates when you will be able to participate in ranked blue star matches. you may still not get a ranked match if you encounter more than one lone battleship in the blue star.",
